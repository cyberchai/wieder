    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-1 container mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="prose prose-stone dark:prose-invert max-w-4xl mx-auto">
          ...
          <h2>questions?</h2>
          <p>
            if you have any questions or concerns, reach out anytime at <a href="mailto:support@nextnode.ventures">support@nextnode.ventures</a> or <a href="https://chairaharder.com" target="_blank" rel="noopener noreferrer">chairaharder.com</a>
          </p>
